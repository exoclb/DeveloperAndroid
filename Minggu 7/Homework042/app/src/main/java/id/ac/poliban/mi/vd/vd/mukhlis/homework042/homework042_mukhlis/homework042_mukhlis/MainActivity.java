package id.ac.poliban.mi.vd.vd.mukhlis.homework042.homework042_mukhlis.homework042_mukhlis;
...
import id.ac.poliban.mi.vd.mukhlis.homework042_sherli.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) getSupportActionBar().setTitle("Checkboxes and etc_Aldy");
    }
