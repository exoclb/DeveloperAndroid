package com.example.homework_73;
...
public class MainActivity {
    ...
    private static final String EXTRA_RANDOM_NUMBER = "com.example.homework_73.RANDOM_NUMBER";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("PowerReceiver Homework_73 Aldy");
